...
# -*- coding: utf-8 -*-
#
# Infolytics documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'infolytics.tex', 'Infolytics Documentation',
   'AppPoint', 'manual'),
]
...
man_pages = [
	(master_doc, 'infolytics', 'Infolytics Documentation',
	 [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'infolytics', 'Infolytics Documentation',
   author, 'infolytics', 'Infolytics Documentation' ),
]
